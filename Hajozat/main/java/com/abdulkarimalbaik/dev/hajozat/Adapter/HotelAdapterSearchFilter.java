...
public class HotelAdapterSearchFilter extends RecyclerView.Adapter<HotelViewHolder>{
    ...
    public HotelAdapterSearchFilter(Activity activity, List<HotelSearchFilter> hotelList) {
