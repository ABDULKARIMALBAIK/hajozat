...
public class RuleAdapter extends RecyclerView.Adapter<FacilityViewHolder> {

    private Context context;
    private List<HotelRule> facilities;
    private List<Integer> items_seleceted;

    public RuleAdapter(Context context, List<HotelRule> facilities) {
        this.context = context;
        this.facilities = facilities;
        items_seleceted = new ArrayList<>();
    }

    public List<HotelRule> getFacilities() {
        return facilities;
    }
    ...
    public void onBindViewHolder(@NonNull FacilityViewHolder holder, int position) {
        ...
        holder.txtFacilityName.setText(facilities.get(position).getDesciption());
    ...
    public void addItem(HotelRule item){
